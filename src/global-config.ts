...
import { InvalidCredencialsErrorFilter } from './shared/infrastructure/exception-filters/invalid-credencials-error/invalid-credencials-error.filter';
...
export function applyGlobalConfig(app: INestApplication) {
  ...
  app.useGlobalFilters(
    ...
    new InvalidCredencialsErrorFilter(),
